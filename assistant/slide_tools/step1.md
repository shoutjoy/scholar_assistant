...
parameters:
  ...
  - name: part
    label: 파트 수
    default: 3
mirrorCustomize: customize/slide_tools/step01_knowledge_map.md
---

[프롬프트: 고해상도 구조 스캔]
* 목표: 업로드된 문서의 모든 섹션, 소제목, 도표, 각주를 누락 없이 스캔하라. {{total}} page설계 {{part}} part로 구성 

수행 작업:
1. 문서의 논리적 흐름에 따라 전체 내용을 {{part}}개의 파트로 나누고, 각 파트당 적절한 슬라이드 주제(총 {{total}}개)를 추출하라. 
